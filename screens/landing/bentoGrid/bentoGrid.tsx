            ...
            <div className="h-full flex flex-col justify-between">
              ...
              <div className="p-6 -mt-56 z-10">
                ...
                <p className="text-gray-600 font-medium max-md:text-sm">
                  Interfaces your users stay in. We design flows that reduce
                  friction and move people toward action.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="h-full flex flex-col">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        >
                          ...
                          <path
                            ...
                            strokeWidth="2"
                          />
                          <circle cx="7" cy="16" fill="currentColor" r="1.5" />
                          <circle cx="12" cy="11" fill="currentColor" r="1.5" />
                          <circle cx="16" cy="15" fill="currentColor" r="1.5" />
                          <circle cx="21" cy="10" fill="currentColor" r="1.5" />
                        </svg>
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600 font-medium max-md:text-sm">
                  Complex data made simple to read, act on, and present to
                  stakeholders.
                </p>
              </div>
            </div>
