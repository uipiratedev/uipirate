                  ...
                  <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl overflow-hidden shadow-2xl border border-gray-700/50 relative h-full">
                    ...
                    <div className="bg-gray-800/80 backdrop-blur-xl px-3 py-1.5 flex items-center gap-2 border-b border-gray-700/50 rounded-t-2xl">
                      <div className="flex gap-1.5">
                        ...
                        <div className="w-2 h-2 rounded-full bg-yellow-500/90"></div>
                        <div className="w-2 h-2 rounded-full bg-green-500/90"></div>
                      </div>
                      ...
                      {[
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="h-0.5 bg-gray-200 rounded-full mb-0.5 w-3/4"></div>
                            <div className="h-0.5 bg-gray-100 rounded-full w-1/2"></div>
                          </div>
                          <div className="flex items-center gap-0.5">
                ...
                <div className="flex-1 mb-1 relative flex items-center justify-center">
                  ...
                  <div className="bg-white/90 backdrop-blur-sm rounded-xl  border border-gray-200/50 shadow-xl w-[280px]">
                    ...
                    <div className="bg-gray-100/60 rounded-lg p-2">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div className="w-10 h-2 bg-gray-300/60 rounded-full"></div>
                        <div className="flex flex-col gap-0.5">
                          <div className="w-3 h-0.5 bg-gray-300/60 rounded"></div>
                          <div className="w-3 h-0.5 bg-gray-300/60 rounded"></div>
                          <div className="w-3 h-0.5 bg-gray-300/60 rounded"></div>
                        </div>
                      </div>
                        ...
                        <div className="flex-1 bg-gray-200/70 rounded-lg h-12 flex items-center justify-center relative overflow-hidden">
                          ...
                          >
                            <path
                              ...
                              opacity="0.6"
                            />
                            <circle cx="48" cy="20" r="6" opacity="0.4" />
                          </svg>
                        </div>

                        {/* Text Lines */}
                        <div className="flex-1 space-y-1 pt-0.5">
                          <div className="w-full h-1.5 bg-gray-300/60 rounded-full"></div>
                          <div className="w-3/4 h-1.5 bg-gray-300/60 rounded-full"></div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1 mb-2">
                        <div className="w-full h-1.5 bg-gray-300/60 rounded-full"></div>
                        <div className="w-2/3 h-1.5 bg-gray-300/60 rounded-full"></div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-1.5">
                        {[1, 2, 3].map((i) => (
                          ...
                          >
                            <div className="w-full h-6 bg-gray-200/60 rounded-sm"></div>
                            <div className="w-full h-1 bg-gray-200/60 rounded-full"></div>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="absolute bottom-0 right-8 bg-white rounded-[14px] p-2 pb-4 shadow-xl border border-gray-200/50 w-20">
                    ...
                    <div className="bg-gray-100/60 rounded-lg p-1.5 space-y-1.5">
                      ...
                      {/* Text Line */}
                      <div className="w-full h-1 bg-gray-300/60 rounded-full"></div>
                      {/* Orange Button */}
                      <div className="w-full h-3 bg-orange-500 rounded-full shadow-lg"></div>
                    </div>
                  </div>
                </div>
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1 flex items-end justify-end relative pb-6 pt-2 pr-0 ">
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    <div className="w-96 h-96 rounded-full absolute bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/10 shadow-[0_0_40px_rgba(59,130,246,0.1)] animate-[spin_20s_linear_infinite]"></div>

                    {/* Middle Circle - Medium rotation (reverse) */}
                    <div className="w-72 h-72 rounded-full absolute bg-gradient-to-br from-blue-100/40 via-purple-100/30 to-pink-100/20 shadow-[0_0_30px_rgba(139,92,246,0.15)] animate-[spin_15s_linear_infinite_reverse]"></div>

                    {/* Inner Circle - Faster rotation */}
                    <div className="w-48 h-48 rounded-full absolute bg-gradient-to-br from-blue-200/50 via-purple-200/40 to-pink-200/30 shadow-[0_0_20px_rgba(168,85,247,0.2)] animate-[spin_10s_linear_infinite]"></div>

                    {/* Center Circle - Fastest rotation (reverse) */}
                    <div className="w-24 h-24 rounded-full absolute bg-gradient-to-br from-blue-400/60 via-purple-400/50 to-pink-400/40 shadow-[0_0_15px_rgba(147,51,234,0.3)] animate-[spin_8s_linear_infinite_reverse]"></div>
