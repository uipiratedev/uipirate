      ...
      <div className="flex flex-row items-center justify-center py-6 w-full max-md:py-0 max-md:pt-1 relative">
        ...
        >
          ...
          <GlassSurface
            ...
            blueOffset={20}
            forceLightMode={true}
            className="md:my-9 max-md:my-5 !flex !flex-row max-md:!flex-col !items-center !gap-3 isolate overflow-visible p-2 px-4"
            style={{
          ...
          >
            ...
            {/* Text */}
            <p className="badge-text relative z-10 max-md:text-xs ml-2 pl-2">
