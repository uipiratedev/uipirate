...
const Community = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full relative overflow-hidden px-4">
      ...
      <div
        className="absolute bottom-1/4 -left-20 w-96 h-96 bg-[#FF5B04]/5 rounded-full blur-[120px] animate-pulse"
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl">
        ...
        <p className="text-lg md:text-xl text-zinc-500 leading-relaxed mb-12 max-w-xl mx-auto">
          We&apos;re building a space for creators, designers, and tech
          enthusiasts to share knowledge. Our community platform is currently
          under development.
        </p>
