...
const Rocket = ({ size = 24, className = "" }: IconProps) => (
  ...
  >
    ...
    <path d="M9 12H4s.5-1 1-4c1.5 0 3 0 3 0l1 4z" />
    <path d="M12 15v5s1-.5 4-1c0-1.5 0-3 0-3l-4-1z" />
  </svg>
);
  ...
  return (
    <div className="min-h-screen  pt-20 pb-20 overflow-hidden container  mx-auto px-32 lg:px-20 max-md:px-4 ">
      <div className="">
        {/* Navigation */}
        <Link
          className="group flex items-center gap-2 text-zinc-400 hover:text-zinc-600 transition-colors mb-12"
          href="/apps4sale"
        >
          <ArrowLeft
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-16 md:mb-24 px-4 md:px-0">
          ...
          >
            <BracketIcon />
            <h3 className="text-lg md:text-2xl font-bold text-zinc-900 mb-4 text-center md:text-left">
          ...
          >
            <BracketIcon />
            <h3 className="text-lg md:text-2xl font-bold text-zinc-900 mb-4">
              Where this fits
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              {mockProduct.whatYouGet.slice(0, 3).map((item, idx) => (
                ...
                >
                  ...
                  <p className="global-title text-white">{item.title}</p>
                </div>
              ))}
            </div>
            ...
            {mockProduct.capabilities.map((capability, idx) => (
              ...
              >
                <div className="w-10 h-10 bg-[#FF5B04]/5 rounded-xl flex items-center justify-center mb-6">
                  <Zap className="text-[#FF5B04]" size={18} />
                </div>
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 px-4">
            ...
            {mockProduct.howItWorks.map((step, idx) => (
              ...
              >
                ...
                <p className="text-[#99A1AF] text-sm max-w-[200px] mx-auto">
                  {step.description}
                </p>
              </div>
            ))}
        ...
        <div className="mb-32">
          ...
          >
            <div className="absolute top-0 right-0 p-8 opacity-0 group-hover:opacity-100 transition-opacity">
              <Settings className="text-[#FF5B04]/[0.02]" size={120} />
            </div>
            ...
            <div>
              ...
              <p className="text-[#99A1AF] leading-relaxed text-lg max-w-3xl">
                The system can be tailored to your product&apos;s workflows,
                branding, and scale requirements. We adapt everything from voice
                tone to routing logic.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-4xl font-black font-normal text-white mb-6">
        ...
        <div className="text-center pt-20">
          <GlassBadge variant="gradient">RECOMMENDED others apps</GlassBadge>
            ...
            {[1, 2, 3].map((i) => (
              <div
                ...
                style={{
                  ...
                  border: "1px solid rgba(0, 0, 0, 0.08)",
                  background:
                    "linear-gradient(131deg, #EDEDED 15%, #FFFFFF 50%, #EDEDED 85%)",
                }}
              >
