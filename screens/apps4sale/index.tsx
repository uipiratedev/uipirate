      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center flex flex-col items-center mb-10 md:mb-16 px-4">
          ...
          <p className="sub-header">
            Production-ready micro apps built for real products. Plug them into
            your workflow, customize as needed, and launch without building from
            scratch.
          </p>
        </div>
          ...
          <div className="relative mb-10 group">
            ...
            <Input
              classNames={{
                ...
                inputWrapper:
                  "h-16 bg-white border-zinc-200 hover:border-zinc-300 focus-within:!border-[#FF5B04] shadow-sm transition-all duration-300",
              }}
            ...
            >
              ...
              >
                ...
                <div className="mt-8 pt-8 border-t border-zinc-50 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                  <span className="text-[#FF5B04] font-bold text-sm uppercase tracking-wider">
                    View Project
                  </span>
                  <svg
                    fill="none"
