  ...
  const useCases = [
    {
      ...
      description:
        "Automate reminders, rescheduling, and pre-op instructions with a natural voice that patients trust.",
      icon: "🏥",
      details: [
        "Syncs with EHR/EMR",
    ...
    },
    {
      ...
      description:
        "Instantly call new leads to qualify their budget, location, and timeline before passing to an agent.",
      icon: "🏠",
      details: [
    ...
    },
    {
      ...
      description:
        "Call customers who abandoned high-value carts to offer support or exclusive discounts.",
      icon: "🛒",
    ...
    },
    {
      ...
      description:
        "Initial triage for technical issues and automated updates for system outages.",
      icon: "🛠️",
      details: [
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-20">
              <div className="flex-1 text-center lg:text-left">
                ...
                >
                  Automate high-volume phone calls with a hybrid engine that
                  combines rule-based efficiency with the intelligence of LLMs.
                  Deploy human-like neural voices that handle complex scenarios
                  instantly.
                </motion.p>
                ...
                >
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-7 text-lg font-bold rounded-2xl shadow-xl shadow-blue-500/20 transition-all hover:scale-105 active:scale-95">
                    Start Building Free
                  </Button>
                  <Button
                ...
                >
                  <img
                    alt="Twilio"
                    className="h-6 grayscale hover:grayscale-0 transition-all cursor-pointer"
                    src="https://upload.wikimedia.org/wikipedia/commons/b/b1/Twilio_logo.svg"
                  />
                  <img
                    alt="AWS"
                    className="h-6 grayscale hover:grayscale-0 transition-all cursor-pointer"
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Amazon_Web_Services_Logo.svg/1280px-Amazon_Web_Services_Logo.svg.png"
                  />
                  <img
                    alt="Gemini"
                    className="h-6 grayscale hover:grayscale-0 transition-all cursor-pointer"
            ...
            <div className="flex flex-col lg:flex-row items-center gap-20">
              <div className="flex-1">
                <h2 className="text-4xl md:text-5xl font-extrabold mb-8 text-slate-900">
                  Modular & Reliable Architecture
                </h2>
                <p className="text-slate-500 text-lg mb-12 leading-relaxed">
                  Our system is built on an event-driven modular framework,
                  ensuring that even if one component experiences an issue, the
                  conversation continues seamlessly using our three-tier
                  fallback logic.
                </p>
                ...
                <div className="space-y-4">
                  {[
                    {
                      title: "Amazon Polly Neural Engine",
                      desc: "Industry-leading text-to-speech with localized accents.",
                      icon: "🎙️",
                    },
                    {
                      title: "Hybrid Decision Engine",
                      desc: "Smart logic that routes simple intents to our ultra-fast Rule Engine.",
                      icon: "⚡",
                    },
                    {
                      title: "Global Webhook Handlers",
                      desc: "Real-time bi-directional data flow for CRM integrations.",
                      icon: "🔗",
                    },
                  ].map((item, i) => (
                    <motion.div
                ...
                <div className="space-y-6">
                  <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100">
                    ...
                    <p className="text-blue-700/60 text-sm">
                      Real-time context-aware conversational logic.
                    </p>
                  </div>
                  ...
                  <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100 opacity-60">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="px-2 py-1 bg-slate-200 text-slate-500 text-[10px] font-bold rounded">
                        STANDBY
                      </span>
                    </div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Cost-effective backup for predictable reliability.
                    </p>
                  </div>
                  <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100 opacity-60">
                    <div className="flex justify-between items-center mb-4">
                    ...
                    <p className="text-slate-400 text-sm">
                      Third-tier resilience for complex edge cases.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-6xl font-black mb-6 text-slate-900 leading-tight">
                Where Excellence Meets <br /> Automation
              </h2>
              <p className="text-slate-500 text-xl max-w-2xl mx-auto">
                AI Voice agents are transforming how industries communicate.
                From medical scheduling to real estate leads.
              </p>
            </div>
                ...
                >
                  ...
                  <ul className="space-y-3 pt-6 border-t border-slate-50">
                    {useCase.details.map((detail, idx) => (
                      ...
                      >
                        <CheckIcon className="text-blue-500" size={16} />
                        {detail}
                      </li>
                    ))}
                  </ul>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-start mb-20 gap-8">
              <div>
                ...
                <p className="text-white/50 text-xl max-w-2xl">
                  End-to-end transparency. See exactly how our system handles an
                  automated appointment reminder call from API request to final
                  action.
                </p>
              </div>
              <Button className="bg-blue-600 hover:bg-blue-500 text-white font-bold h-16 px-10 rounded-2xl">
                View Detailed Flow
              </Button>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {callFlowSteps.map((step, i) => (
                <div
                  key={i}
                  className="relative p-8 bg-white/5 rounded-[2.5rem] border border-white/10 hover:bg-white/10 transition-all group"
                >
            ...
            <div className="flex flex-col lg:flex-row gap-20">
              <div className="flex-1">
                ...
                <h2 className="text-4xl md:text-5xl font-extrabold mb-8">
                  Integrated with <br /> Developer Workflows
                </h2>
                <p className="text-slate-500 text-lg mb-12">
                  Our RESTful API is designed for speed. Use simple endpoints to
                  start calls, fetch histories, and receive bi-directional
                  webhooks.
                </p>
                  ...
                  {[
                    {
                      method: "POST",
                      url: "/v1/calls/start",
                      desc: "Initiate a neural voice call instantly.",
                    },
                    {
                      method: "GET",
                      url: "/v1/calls/history",
                      desc: "Fetch full conversation transcripts.",
                    },
                    {
                      method: "POST",
                      url: "/v1/webhooks/voice",
                      desc: "Twilio webhook for real-time handling.",
                    },
                    {
                      method: "GET",
                      url: "/v1/health",
                      desc: "Monitor system and engine status.",
                    },
                  ].map((endpoint, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-6 p-4 rounded-xl border border-slate-50 hover:border-blue-100 transition-all hover:bg-blue-50/20 group"
                    >
                      <span
                        className={`w-16 text-center font-bold text-xs py-1 rounded ${endpoint.method === "POST" ? "bg-blue-100 text-blue-600" : "bg-slate-100 text-slate-500"}`}
                      >
                        {endpoint.method}
                      </span>
                      <code className="text-sm font-bold text-slate-800 flex-1">
                        {endpoint.url}
                      </code>
                  ...
                  <div className="p-4 font-mono text-sm overflow-x-auto">
                    <pre className="text-white/80">
                      ...
                      <span className="text-blue-400">
                        "https://api.uipirate.com/v1/calls/start"
                      </span>{" "}
                      \<br />
                      &nbsp;&nbsp;-H{" "}
                      ...
                      <span className="text-yellow-400">
                        '&#123; "to_phone": "+1931...", "context": "reminder"
                        &#125;'
                      </span>
                    </pre>
                  </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-[3rem] p-12 md:p-20 shadow-xl border border-slate-100 relative overflow-hidden text-center">
              ...
              <h2 className="text-4xl font-black mb-6">
                Predictable Costs. <br /> Premium Value.
              </h2>
              <p className="text-slate-500 text-lg mb-12">
                Transparent pricing from Twilio, Amazon Polly, and major LLM
                providers. <br />
                We take exactly{" "}
                <span className="text-blue-600 font-black">0% margin</span> on
                infrastructure.
              </p>
              <div className="flex justify-center flex-wrap gap-x-12 gap-y-6">
                <div className="text-center">
                  <p className="text-2xl font-black mb-1 text-slate-800">
                    $0.00
                  </p>
        ...
        <section className="py-32 relative overflow-hidden bg-white">
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-5xl md:text-7xl font-black mb-12 tracking-tight">
              Experience Voice <br /> Intelligence.
            </h2>
            <div className="flex justify-center gap-6 flex-col sm:flex-row">
              <Button className="bg-slate-900 text-white font-black h-16 px-12 rounded-2xl text-lg hover:bg-slate-800 transition-all hover:scale-105">
                Get Free API Key
              </Button>
              <Button className="bg-blue-600 text-white font-black h-16 px-12 rounded-2xl text-lg hover:bg-blue-700 transition-all hover:scale-105">
                Talk to Sales
              </Button>
            </div>
            <p className="mt-12 text-slate-400 font-bold text-sm tracking-widest uppercase">
