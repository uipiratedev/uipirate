  ...
  return (
    <section className="py-12 md:py-20">
      <div className="max-w-3xl mx-auto text-center px-4">
        ...
        {/* Heading */}
        <h2 className="heading-center">Stay In The Loop</h2>
        ...
        <div className="flex items-center justify-center gap-3 mb-5">
          <p
            className="tracking-[0.2em] text-xl max-md:text-base font-semibold text-slate-900 uppercase "
        ...
        {/* Description */}
        <div
          className="space-y-1 text-xs md:text-sm mb-8 leading-relaxed"
