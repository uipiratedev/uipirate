...
export default function VintageLeatherScreen() {
  ...
  const [stateMode, setStateMode] =
    useState<VintageLeatherStateMode>("interactive");
        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Crafted skeuomorphic button featuring authentic saddle leather
              grain noise, engraved vector scrollwork flourishes, and rich brass
              bevel highlights.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={theme}
                  onChange={(e) =>
                    setTheme(e.target.value as VintageLeatherTheme)
                  }
                >
                  <option className="bg-[#101014]" value="heritage">
                    Brass & Saddle (1:1 spec)
                  </option>
                  <option className="bg-[#101014]" value="uipirate">
                    UI Pirate Burnt Orange
                  </option>
                  <option className="bg-[#101014]" value="obsidian">
                    Obsidian Gold
                  </option>
                  <option className="bg-[#101014]" value="emerald">
                    British Racing Green
                  </option>
                  <option className="bg-[#101014]" value="ruby">
                    Burgundy Wine
                  </option>
                  <option className="bg-[#101014]" value="silver">
                    Brushed Titanium
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as VintageLeatherStateMode)
                  }
                >
                  <option className="bg-[#101014]" value="interactive">
                    Interactive
                  </option>
                  <option className="bg-[#101014]" value="standerd">
                    Standard
                  </option>
                  <option className="bg-[#101014]" value="hover">
                    Hover
                  </option>
                </select>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-400 font-mono">
                Hover &amp; click to preview heritage tactile embossed leather
                &amp; brass bevel flourishes
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  <div className="w-full flex items-center justify-between text-xs font-mono text-gray-400 mb-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-white/5 text-[10px] text-amber-300">
                      theme=&quot;heritage&quot;
                    </span>
                  </div>
                  <div className="my-3">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    1:1 reference design with embossed cowhide leather &amp;
                    brass lip
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Signature magma orange leather with filigree corner
                    ornaments
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Medieval steel &amp; silver chassis with filigree corner
                    ornaments
                  </span>
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs sm:text-sm">
                  ...
                  <tbody className="divide-y divide-white/5 text-gray-300 font-mono text-xs">
                    <tr>
                      <td className="py-3 px-6 text-amber-400 font-semibold">
                        label
                      </td>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Text displayed on the leather cap
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-amber-400 font-semibold">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Renders decorative flourish scrollwork
                      </td>
                    </tr>
                  </tbody>
                </table>
