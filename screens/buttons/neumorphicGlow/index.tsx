...
export default function NeumorphicGlowScreen() {
  ...
  const [stateMode, setStateMode] =
    useState<NeumorphicGlowStateMode>("interactive");
  const [neonPreset, setNeonPreset] = useState<NeumorphicNeonPreset | "auto">(
    "auto",
  );
        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Multi-tier soft neumorphic clay button featuring dual convex
              lighting shadows, glowing neon arrow badge, and spring depth
              feedback.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={variant}
                  onChange={(e) =>
                    setVariant(e.target.value as NeumorphicGlowShape)
                  }
                >
                  <option className="bg-[#151518] text-white" value="pill">
                    Pill
                  </option>
                  <option className="bg-[#151518] text-white" value="squircle">
                    Squircle
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={theme}
                  onChange={(e) =>
                    setTheme(e.target.value as NeumorphicGlowTheme)
                  }
                >
                  <option className="bg-neutral-900" value="default">
                    Clay Light (1:1 spec)
                  </option>
                  <option className="bg-neutral-900" value="uipirate">
                    UI Pirate Orange
                  </option>
                  <option className="bg-neutral-900" value="dark">
                    Obsidian Slate
                  </option>
                  <option className="bg-neutral-900" value="cyberpunk">
                    Cyberpunk Violet
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as NeumorphicGlowStateMode)
                  }
                >
                  <option
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-400 font-mono">
                Hover over buttons to trigger specular clay elevation &amp; neon
                badge bloom
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    1:1 reference design with glowing emerald arrow badge
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Signature magma orange neumorphic clay squircle
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Cyan optical underglow badge with specular bevel lip
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  <div className="w-full flex items-center justify-between text-xs font-mono text-gray-400 mb-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-white/5 text-[10px] text-pink-400">
                      neonPreset=&quot;magenta&quot;
                    </span>
                  </div>
                  <div className="my-3">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Vivid magenta bloom badge with clay squircle chassis
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Warm golden amber indicator badge depth glow
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Ultraviolet neon arrow badge with 3D drop shadows
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-neutral-900/80 border border-neutral-800 rounded-3xl p-6 sm:p-8 space-y-6">
              <p className="text-sm text-gray-300 leading-relaxed">
                Install required peer dependencies for Framer Motion spring
                physics:
              </p>
                ...
                <table className="w-full text-left text-xs sm:text-sm">
                  ...
                  <tbody className="divide-y divide-neutral-800 text-gray-300 font-mono text-xs">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Physical rounded contour geometry
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-emerald-400 font-semibold">
