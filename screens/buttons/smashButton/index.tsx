...
export default function SmashTactileButtonScreen() {
  ...
  const [size, setSize] = useState<"xs" | "sm" | "md" | "lg" | "xl" | "hero">(
    "md",
  );
  const [stateMode, setStateMode] =
    useState<SmashTactileButtonState>("interactive");
        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white font-jakarta">
              Smash Tactile{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-violet-200 to-purple-500">
                Haptic Button
              </span>
            </h1>

            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Multi-tier tactile compression button featuring porcelain cushion
              trays, dot-matrix arrays, internal optical flare beam, and deep
              haptic depression.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={variant}
                  onChange={(e) =>
                    setVariant(e.target.value as SmashButtonVariant)
                  }
                >
                  <option className="bg-[#151518]" value="default">
                    Default (1:1)
                  </option>
                  <option className="bg-[#151518]" value="dark">
                    Dark Cyan
                  </option>
                  <option className="bg-[#151518]" value="orange">
                    UI Pirate Orange
                  </option>
                  <option className="bg-[#151518]" value="cyberpunk">
                    Cyberpunk Pink
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option className="bg-[#151518] text-white" value="hero">
                    Hero
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as SmashTactileButtonState)
                  }
                >
                  <option
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-400 font-mono">
                Hover &amp; click to trigger neo-brutalist mechanical smash
                depression
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  <div className="w-full flex items-center justify-between text-xs font-mono text-gray-400 mb-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-white/5 text-[10px] text-purple-300">
                      variant=&quot;default&quot;
                    </span>
                  </div>
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    1:1 reference design with porcelain enclosure tray &amp; dot
                    matrix
                  </span>
                </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs sm:text-sm">
                  ...
                  <tbody className="divide-y divide-white/5 text-gray-300 font-mono text-xs">
                    <tr>
                      <td className="py-3 px-6 text-purple-400 font-semibold">
                        label
                      </td>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Text displayed on the central core cap
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-purple-400 font-semibold">
