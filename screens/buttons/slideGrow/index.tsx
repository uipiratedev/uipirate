        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Smooth gesture swipe-to-grow slider button featuring dynamic laser
              channel reveal, spring damping, and physical knob transformation.
            </p>
          </header>
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                >
                  <option className="bg-neutral-900" value="silver">
                    Brushed Silver (1:1 spec)
                  </option>
                  ...
                  <option className="bg-neutral-900" value="emerald">
                    Emerald
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as SlideGrowStateMode)
                  }
                >
                  <option
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    1:1 reference design with blue illuminated channel
                  </span>
                </div>
                  ...
                  <tbody className="divide-y divide-neutral-800 text-gray-300 font-mono text-xs">
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Initial label displayed in resting state
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-blue-400 font-semibold">
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Active label revealed when slider completes
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-blue-400 font-semibold">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Callback fired when slider is pulled to completion
                      </td>
                    </tr>
                  </tbody>
                </table>
