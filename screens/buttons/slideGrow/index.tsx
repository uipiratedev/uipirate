            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="slid" className="bg-[#151518] text-white">Slide</option>
                </select>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-4 border-b border-neutral-800 bg-white/[0.02]">
                ...
                <div className="flex items-center bg-black/40 p-1 rounded-xl border border-white/5 text-xs">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-colors font-medium ${activeCodeTab === "component" ? "bg-blue-600 text-white" : "text-gray-400 hover:text-white"
                      }`}
                  >
                    Component.tsx
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-colors font-medium ${activeCodeTab === "usage" ? "bg-blue-600 text-white" : "text-gray-400 hover:text-white"
                      }`}
                  >
                    Usage.tsx
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-colors font-medium ${activeCodeTab === "css" ? "bg-blue-600 text-white" : "text-gray-400 hover:text-white"
                      }`}
                  >
                    Tokens.css
                  </button>
