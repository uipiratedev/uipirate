...
export default function ScalingCapsuleButtonScreen() {
  ...
  const [stateMode, setStateMode] =
    useState<ScalingCapsuleStateMode>("interactive");
        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <div className="text-center space-y-5 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Interactive capsule button engineered with a frosted translucent
              glass cavity tray, multi-tier elevation drop shadows, specular
              bevel insets, and an embedded circular apex emblem badge.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={variant}
                  onChange={(e) =>
                    setVariant(e.target.value as ScalingCapsuleVariant)
                  }
                >
                  <option className="bg-[#151518] text-white" value="dark">
                    Dark
                  </option>
                  <option className="bg-[#151518] text-white" value="orange">
                    Orange
                  </option>
                  <option className="bg-[#151518] text-white" value="light">
                    Light
                  </option>
                  <option className="bg-[#151518] text-white" value="cyberpunk">
                    Cyberpunk
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as ScalingCapsuleStateMode)
                  }
                >
                  <option
                    className="bg-[#151518] text-white"
                    value="interactive"
                  >
                    Interactive
                  </option>
                  <option className="bg-[#151518] text-white" value="standerd">
                    Standard
                  </option>
                  <option className="bg-[#151518] text-white" value="hover">
                    Hover
                  </option>
                </select>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-400 font-mono">
                Hover over buttons to test frosted glass capsule elevation &amp;
                multi-tier shadow stacks
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-between min-h-[220px] overflow-x-clip transition-all hover:border-white/15">
                  <div className="w-full flex items-center justify-between text-xs font-mono text-gray-400 mb-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-white/5 text-[10px] text-blue-300">
                      variant=&quot;light&quot;
                    </span>
                  </div>
                  <div className="my-3">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#151518] border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6">
              <p className="text-sm text-gray-300 leading-relaxed">
                This component is self-contained and powered by{" "}
                <strong className="text-white">Framer Motion</strong> for spring
                physics and <strong className="text-white">Tailwind CSS</strong>{" "}
                for styling. Install the required peer dependency:
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 space-y-1">
                  ...
                  <p className="text-xs text-gray-400">
                    ...
                    <code className="text-orange-400 font-mono">
                      components/ScalingCapsuleButton.tsx
                    </code>
                    .
                  </p>
                </div>
                <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 space-y-1">
                  ...
                  <p className="text-xs text-gray-400">
                    Drop into any Next.js (App/Pages) or React project.
                  </p>
                </div>
                <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 space-y-1">
                  <span className="text-xs font-semibold text-white">
                  ...
                  <p className="text-xs text-gray-400">
                    Pass custom labels, variants, sizes, and click handlers.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <tbody className="divide-y divide-white/5 text-gray-300 font-mono text-xs">
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Text displayed on the button cap
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-orange-400 font-semibold">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Custom icon or emblem component
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-orange-400 font-semibold">
