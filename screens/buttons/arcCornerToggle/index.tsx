        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Curved quadrant arc corner toggle button engineered with true
              185.6px radial arc offset-path tracking, day/night gradient
              themes, and physical spring damping.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={trackStyle}
                  onChange={(e) =>
                    setTrackStyle(e.target.value as "arc" | "line")
                  }
                >
                  <option className="bg-[#151518] text-white" value="arc">
                    Corner Arc
                  </option>
                  <option className="bg-[#151518] text-white" value="line">
                    Straight Line
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as ArcToggleStateMode)
                  }
                >
                  <option
                    className="bg-[#151518] text-white"
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-400 font-mono">
                Click any toggle to test distinct interactive states &amp;
                speeds
              </p>
            </div>
            ...
            <div className="bg-[#151518]/90 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-5 flex flex-col items-center justify-between min-h-[360px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <div className="flex items-center justify-center my-2">
                    <ArcCornerToggle duration={0.35} scale={0.5} />
                  </div>
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-5 flex flex-col items-center justify-between min-h-[360px] overflow-x-clip transition-all hover:border-white/15">
                  <div className="w-full flex items-center justify-between text-xs font-mono text-gray-400 mb-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-white/5 text-[10px] text-[#ED45BE]">
                      track=&quot;line&quot;
                    </span>
                  </div>
                  <div className="flex items-center justify-center my-2">
                  ...
                  <span className="text-[11px] font-mono text-gray-500 text-center">
                    Linear horizontal groove — knob slides left ➜ right, no
                    rotation
                  </span>
                </div>
                ...
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-5 flex flex-col items-center justify-between min-h-[360px] overflow-x-clip transition-all hover:border-white/15">
                  ...
                  <div className="flex items-center justify-center my-2">
                    <ArcCornerToggle duration={1.8} scale={0.5} />
                  </div>
                  <span className="text-[11px] font-mono text-gray-500 text-center">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs sm:text-sm">
                  ...
                  <tbody className="divide-y divide-white/5 text-gray-300 font-mono text-xs">
                    <tr>
                      <td className="py-3 px-6 text-pink-400 font-semibold">
                        isActive
                      </td>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Controlled active state boolean
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-pink-400 font-semibold">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Callback fired upon toggling state
                      </td>
                    </tr>
                  </tbody>
                </table>
