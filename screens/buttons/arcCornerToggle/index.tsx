...
export default function ArcCornerToggleScreen() {
  ...
  const [stateMode, setStateMode] = useState<ArcCornerToggleStateMode>("interactive");
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center text-xs font-mono tracking-widest uppercase opacity-70">
        <span style={{ color: textColor }}>{active ? "Dark Mode" : "Light Mode"}</span>
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  value={stateMode}
                  onChange={(e) => setStateMode(e.target.value as ArcCornerToggleStateMode)}
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-white font-mono"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#151518]/90 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Light Mode Standard */}
                <div className="bg-[#101012] border border-white/5 rounded-2xl p-5 flex flex-col items-center justify-between min-h-[380px] overflow-hidden transition-all hover:border-white/15">
                  ...
                  <div className="flex items-center justify-center my-3 max-w-full">
                    <ArcCornerToggle
                      scale={0.72}
                      duration={0.65}
                      themeMode="light"
