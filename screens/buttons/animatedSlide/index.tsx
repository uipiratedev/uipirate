...
export default function AnimatedSlideButtonScreen() {
  ...
  const [stateMode, setStateMode] =
    useState<AnimatedButtonStateMode>("interactive");
        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              High-converting dual-text roll CTA button. Hovering replaces the
              primary label with a secondary action message through smooth
              vertical translation with overflow clipping.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={size}
                  onChange={(e) =>
                    setSize(e.target.value as AnimatedButtonSize)
                  }
                >
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as AnimatedButtonStateMode)
                  }
                >
                  <option
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#151518] border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6">
              <p className="text-sm text-gray-300 leading-relaxed">
                This component is lightweight and built with Tailwind CSS
                transitions:
              </p>
                  ...
                  <tbody className="divide-y divide-white/5 text-gray-300 font-mono text-xs">
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Initial text displayed in resting state
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-orange-400 font-semibold">
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Secondary text revealed upon hover roll
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-orange-400 font-semibold">
