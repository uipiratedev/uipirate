  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center max-h-[22px] overflow-hidden">
        <span
          className="transition-transform duration-300 ease-in-out transform group-hover:translate-y-[40px] translate-y-2.5"
          style={{ color: textColor }}
        >
          {primaryText}
        </span>
        <span
          className="transition-transform duration-300 ease-in-out transform translate-y-[40px] group-hover:-translate-y-2.5 font-bold"
          style={{ color: textColor }}
        >
          {hoverText}
        </span>
      ...
      <div className="relative overflow-hidden min-h-screen bg-[#0E0E10] text-gray-100 selection:bg-[#FF5B04] selection:text-white pt-6 pb-20">
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <div className="bg-[#151518]/90 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="w-auto max-w-full flex justify-center p-4">
              <AnimatedButton
                primaryText={primaryText}
                hoverText={hoverText}
                textColor={textColor}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-black/50 border border-white/10 text-white text-sm focus:outline-none focus:border-[#FF5B04] font-mono"
                >
                  <option value="interactive" className="bg-[#18181B] text-white">Interactive</option>
                  <option value="standerd" className="bg-[#18181B] text-white">Standard</option>
                  <option value="hover" className="bg-[#18181B] text-white">Hover</option>
                </select>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-4 border-b border-white/10 bg-white/[0.02]">
                ...
                <div className="flex items-center bg-black/40 p-1 rounded-xl border border-white/5 text-xs">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-colors font-medium ${activeCodeTab === "component" ? "bg-[#FF5B04] text-white" : "text-gray-400 hover:text-white"
                      }`}
                  >
                    Component.tsx
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-colors font-medium ${activeCodeTab === "usage" ? "bg-[#FF5B04] text-white" : "text-gray-400 hover:text-white"
                      }`}
                  >
                    Usage.tsx
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg transition-colors font-medium ${activeCodeTab === "css" ? "bg-[#FF5B04] text-white" : "text-gray-400 hover:text-white"
                      }`}
                  >
                    Tokens.css
                  </button>
