...
const COLOR_PRESETS = [
  { label: "Default Aqua", value: "#54EAD8", name: "Aqua" },
        ...
        <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <header className="text-center space-y-4 max-w-3xl mx-auto pt-6">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Skeuomorphic tactile pill button featuring mechanical spring tilt,
              recessed cavity slot reveal, and glowing radiant LED status
              beacon.
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={stateMode}
                  onChange={(e) =>
                    setStateMode(e.target.value as TactileButtonState)
                  }
                >
                  <option
                    className="bg-[#151518] text-white"
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-400 font-mono">
                Hover &amp; click buttons to trigger -9.23° spring tilt &amp;
                slot depth cavity depression
              </p>
            </div>
                ...
                <table className="w-full text-left text-xs sm:text-sm">
                  ...
                  <tbody className="divide-y divide-white/5 text-gray-300 font-mono text-xs">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-6 font-sans text-gray-300">
                        Hex color of the beacon LED indicator
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-6 text-orange-400 font-semibold">
