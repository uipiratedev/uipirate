          ...
          >
            ...
            <div className="hidden md:block absolute left-0 right-0 top-[-10px] h-[100px] z-0 opacity-100 pointer-events-none">
              ...
              >
                {/* Outer Rope Blur */}
                <path
                  className="opacity-20 translate-y-1 blur-[2px]"
                  d="M0 15 Q 600 85 1200 15"
                  fill="none"
                  stroke="#FF5B04"
                  strokeWidth="4"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 container gap-6 md:gap-12 relative z-10 pt-1 md:pt-0 mx-auto xl:px-24 md:mb-32">
              {row.map((card, colIdx) => (
                <div
                  ...
                  style={
                    { "--rope-offset": getCardStyle(colIdx).marginTop } as any
                  }
                >
                  ...
                  <div className="w-full h-full relative px-4 pl-8">
                    ...
                    <div
                      className={`w-full origin-top ${getCardRotationClass(colIdx)}`}
                    >
                      {/* Card Container - Now sways relative to the tilted wrapper */}
                      <div
                        className="w-full md:mt-4 h-full flex flex-col rounded-[32px] p-2 md:pt-14 max-md:pl-8 transition-transform duration-500 hover-swing-card origin-top"
                        style={{ boxShadow: "0px 3px 15px 3px #FFC8DC" }}
                      >
                        <div
                          className="bg-[#F2F3F5] rounded-[24px] pt-5 pb-6 px-6 shadow-[0_18px_45px_rgba(0,0,0,0.08)] border border-gray-100 w-full hover:shadow-[0_22px_55px_rgba(0,0,0,0.12)] transition-all duration-300 group relative z-10 h-full flex flex-col"
                          style={{
