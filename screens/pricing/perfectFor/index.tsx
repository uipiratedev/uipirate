...
const PERFECT_FOR = [
  {
    ...
    description: "Ship fast and impress investors with premium UI that stands out in competitive markets.",
    image: "https://res.cloudinary.com/dvk9ttiym/image/upload/v1771828331/sass_em8jqs.svg",
  },
  {
    title: "SaaS Companies",
    description: "Without in-house design teams, needing consistent updates and design system maintenance.",
    image: "https://res.cloudinary.com/dvk9ttiym/image/upload/v1771828331/tems_mhv5e9.svg",
  },
  {
    title: "Agencies",
    description: "White-label design support for client projects when your team is at capacity.",
    image: "https://res.cloudinary.com/dvk9ttiym/image/upload/v1771831381/creator_qzziot.svg",
  },
  {
    title: "Enterprise Teams",
    description: "Overflow design capacity without the overhead of hiring full-time designers.",
    image: "https://res.cloudinary.com/dvk9ttiym/image/upload/v1771831381/brand_qbdqtq.svg",
  },
];
    ...
    >
      ...
      >
        ...
        <p className="text-gray-500 font-medium text-xs uppercase tracking-wider mb-5 flex items-center gap-2">
          <span className="w-5 h-5 rounded-full bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-400 text-[10px]">✕</span>
          Not the right fit
        </p>
