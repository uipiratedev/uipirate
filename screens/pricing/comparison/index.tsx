  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="heading-center">How We Stack Up</h2>
        <p className="text-gray-500 mt-2 max-w-xl mx-auto">
          See why 50+ companies chose us over traditional agencies, freelancers,
          or hiring in-house.
        </p>
      </div>
      ...
      <Card className="rounded-[20px] max-md:rounded-[12px] border border-gray-200 shadow-sm overflow-hidden">
        <CardBody className="p-0">
          ...
          <div className="grid grid-cols-5 max-md:grid-cols-3 bg-gray-50 border-b border-gray-200">
            <div className="p-4 max-md:p-3 font-semibold text-gray-500 text-sm" />
