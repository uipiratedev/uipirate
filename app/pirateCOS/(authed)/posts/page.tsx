        ...
        <div className="flex flex-col lg:flex-row gap-3 items-center w-full">
          ...
          <div className="flex-1 w-full">
            <Input
              classNames={{
                inputWrapper:
                  "bg-black/5 border-transparent shadow-none h-11 rounded-xl focus-within:bg-black/[0.08] transition-all",
          ...
          <div className="flex w-full lg:w-auto items-center gap-3">
            ...
            <div
              ref={statusRef}
              className="relative w-full lg:w-44 flex-shrink-0"
            >
              <button
        ...
        {loading ? (
          ...
          <div className="p-16 text-center flex flex-col items-center gap-4">
            ...
            {!searchQuery && (
              <Link href={getHref("/posts/create")}>
                <Button
                  className="font-geist font-medium text-white text-sm h-10 px-5 rounded-xl gap-2 mt-1"
                  style={{ background: "#FF5B04" }}
                >
                  <IconCreate /> New Post
                </Button>
