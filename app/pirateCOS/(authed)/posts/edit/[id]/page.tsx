      ...
      >
        <div className="p-6">
          <div className="flex items-start gap-4 mb-5">
            ...
            <div>
              <h3 className="text-base font-bold font-geist text-gray-900 mb-1">
                Unpublish Post
              </h3>
              <p className="text-xs font-geist text-gray-500 leading-relaxed">
                ...
                will be moved to drafts and will no longer be publicly visible.
              </p>
            </div>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-xl p-3.5 flex gap-2.5 mb-5">
            ...
            <p className="text-[11px] font-geist text-amber-800 leading-normal">
              This action can be reversed by publishing the post again at any
              time.
            </p>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="bg-red-50 border border-red-100 rounded-xl p-3.5 mb-5">
            <p className="text-xs font-geist text-gray-600 mb-2.5">
              Type{" "}
              <span className="font-bold font-jetbrains-mono text-red-600 tracking-wider">
                DELETE
              </span>{" "}
              to confirm:
            </p>
        ...
        {isSuccess ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm font-geist text-gray-500 mb-6">
              Your post has been successfully updated and published.
            </p>
