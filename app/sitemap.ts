...
const STATIC_PAGES: {
  ...
  { path: "/tools/saas-ux-audit", priority: 0.9, changeFrequency: "monthly" as const },
  { path: "/tools/landing-page-analyzer", priority: 0.9, changeFrequency: "monthly" as const },
  { path: "/tools/pricing-page-analyzer", priority: 0.85, changeFrequency: "monthly" as const },
  { path: "/tools/design-tokens", priority: 0.85, changeFrequency: "monthly" as const },
