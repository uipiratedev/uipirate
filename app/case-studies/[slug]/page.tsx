      ...
      <div className="container mx-auto px-8 max-md:px-4 max-w-4xl">
        ...
        {(["problem", "approach", "solution", "results"] as const).map(
          (key) => (
            <section key={key} className="mb-10">
              <h2 className="text-xl font-bold text-gray-900 capitalize mb-3">
                {key}
              </h2>
        ...
        <div className="bg-gray-900 text-white rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-3">
            Want Similar Results? Share Your Product Idea
          </h2>
          <p className="text-gray-300 mb-6 text-sm">
            Share your product idea — we handle product thinking, design, and
            Angular/React build.
          </p>
          <Link
