...
export const metadata: Metadata = {
  ...
  description:
    "Analyze your website copy for reading grade level, jargon density, sentence complexity, and cognitive load.",
  alternates: {
...
export default function WebsiteReadabilityCheckerNestedPage() {
