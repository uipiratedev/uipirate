...
export const metadata: Metadata = {
  ...
  description:
    "Test color pairings against WCAG 2.1 AA/AAA contrast ratios and APCA standards for web and SaaS UI accessibility. Free tool by UI Pirate.",
  alternates: {
    canonical: "https://uipirate.com/tools/contrast-checker",
  },
};
...
const spec: UpcomingToolSpec = {
  ...
  keyMetrics: [
    ...
    {
      name: "Auto-Tuned Accessible Palette",
      desc: "Automatically shifts lightness values to generate the nearest WCAG-compliant color token.",
    },
  ],
  howItWorks: [
    {
  ...
  faqs: [
    {
      ...
      a: "WCAG 2.1 uses a simple mathematical luminance ratio, whereas APCA (Advanced Perceptual Contrast Algorithm) accounts for human vision physiology, font sizes, and weight.",
    },
    {
      q: "Why is accessibility important for B2B SaaS?",
      a: "Enterprise procurement often requires VPAT / Section 508 compliance. Accessible products also reduce user eye fatigue and boost conversion.",
    },
  ],
};
