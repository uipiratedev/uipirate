...
export const metadata: Metadata = {
  ...
  description:
    "Generate mathematical 8-point spatial scales, component padding tokens, and layout grids for Figma and Tailwind CSS.",
  alternates: {
    canonical: "https://uipirate.com/tools/design/8pt-grid-calculator",
  },
};
  ...
  faqs: [
    {
      ...
      a: "8 is easily divisible by 2 and 4, works cleanly across all common screen resolutions and pixel densities, and eliminates arbitrary spacing decisions.",
    },
  ],
};

export default function EightPtGridCalculatorNestedPage() {
