...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://uipirate.com/tools/typography-scale-generator",
  },
};
  ...
  faqs: [
    {
      ...
      a: "A modular scale uses a fixed mathematical multiplier (e.g. 1.25 for Major Third) to derive harmonious heading sizes instead of picking arbitrary numbers.",
    },
  ],
};
