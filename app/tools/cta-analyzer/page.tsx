...
export const metadata: Metadata = {
  ...
  description:
    "Audit your website and SaaS conversion buttons for color contrast, action verb strength, visual weight, and viewport placement. Free CTA analyzer by UI Pirate.",
  alternates: {
    canonical: "https://uipirate.com/tools/cta-analyzer",
  },
};
...
const spec: UpcomingToolSpec = {
  ...
  faqs: [
    ...
    {
      q: "Should I have more than one primary button above the fold?",
      a: "No. Offering competing primary visual weights creates decision paralysis. Have one dominant primary action and style alternatives as subtle secondary links.",
    },
  ],
};
