// Admin panel SVG icons — minimal 20×20, stroke-based, consistent 1.5px stroke
const iconProps = {
  width: 20,
  height: 20,
  viewBox: "0 0 24 24",
...
export const IconDashboard = ({ className = "" }: { className?: string }) => (
  <svg {...iconProps} stroke="currentColor" className={className}>
...
export const IconBlogs = ({ className = "" }: { className?: string }) => (
  <svg {...iconProps} stroke="currentColor" className={className}>
...
export const IconDraft = ({ className = "" }: { className?: string }) => (
  <svg {...iconProps} stroke="currentColor" className={className}>
