...
const helpContent: Record<string, { title: string; badge: string; description: React.ReactNode }> = {
  ai: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>AI Co-pilot</strong> is your interactive writing partner. Here is what you can do:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Contextual Writing:</strong> Chat with AI to draft articles, outline ideas, or continue writing sections of your editor content.</li>
          <li><strong>Dynamic Suggestions:</strong> Click tailored suggestion chips generated dynamically based on your content type and goal.</li>
          <li><strong>Multi-Engine Access:</strong> Switch between major model pools (like Google Gemini) using the engine selectors.</li>
        </ul>
      </div>
    ),
  },
  history: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>Generation History</strong> tab tracks all texts generated by the AI during this session:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Browse History:</strong> View previous outputs chronologically.</li>
          <li><strong>One-Click Insert:</strong> Re-insert or replace editor text with any historical generation item.</li>
        </ul>
      </div>
    ),
  },
  snippets: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>Snippet Library</strong> lets you save and reuse generated content:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Save Outputs:</strong> Save custom paragraphs, CTAs, or definitions by clicking the bookmark/snippet icon on any generated chat message.</li>
          <li><strong>Quick Insert:</strong> Insert saved snippets anywhere in your editor with a single tap.</li>
        </ul>
      </div>
    ),
  },
  rewrite: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>Rewrite Tool</strong> polishes and modifies highlighted editor text instantly:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Select Text First:</strong> Select any block of text in the editor to activate this panel.</li>
          <li><strong>Directives & Tone:</strong> Toggle presets (Improve flow, shorten, expand) or select a custom writing voice (Professional, Conversational, Technical, Bold, Empathetic).</li>
          <li><strong>Apply Options:</strong> Replace your selection directly, or insert the result below it.</li>
        </ul>
      </div>
    ),
  },
  content: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>Content Settings</strong> tab manages structural metrics and attributes:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Real-time Analytics:</strong> Keep track of live word counts, character limits, paragraph structures, and estimated read times.</li>
          <li><strong>AI Title Optimizer:</strong> Use instructions and constraints to generate optimized, highly-clickable headlines.</li>
          <li><strong>Tags & Excerpts:</strong> Write summary descriptions or ask the AI to recommend tags for the post.</li>
        </ul>
      </div>
    ),
  },
  seo: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>SEO & Metadata</strong> tab helps optimize your search engine footprint:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Focus Keyword:</strong> Target a search term and monitor how well your post title, headings, and intro text integrate it.</li>
          <li><strong>Google Preview:</strong> Enter SEO titles and descriptions, keeping an eye on the character length indicators.</li>
          <li><strong>AI Metadata Generation:</strong> Ask the AI to read your post and automatically suggest highly optimized titles, descriptions, and keywords.</li>
        </ul>
      </div>
    ),
  },
  health: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>Content Health</strong> panel monitors publication readiness in real time:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Weighted Scoring:</strong> Calculates a score from 0-100 based on strategic priorities (traffic, conversion, engagement, etc.).</li>
          <li><strong>Granular Metrics:</strong> Click Readability, Engagement, Structure, SEO, or CTA categories to view specific optimization recommendations.</li>
        </ul>
      </div>
    ),
  },
  distribute: {
    ...
    description: (
      <div className="space-y-2 text-xs">
        <p>The <strong>Distribute</strong> tab helps publish your content to external platforms:</p>
        <ul className="list-disc pl-4 space-y-1">
          <li><strong>Publish Presets:</strong> Tap a preset growth chain (like SEO Growth or Founder Authority) to auto-configure channels.</li>
          <li><strong>AI Repurposing:</strong> Automatically generate promotional spin-offs (like LinkedIn posts, Twitter threads, or digests) to maximize post reach.</li>
          <li><strong>Publishing Status:</strong> Connect integrations, push posts live, or retry failed transfers.</li>
        </ul>
      </div>
    ),
  },
  ...
  return (
    <>
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-black/5 bg-white flex-shrink-0 h-[52px]">
                  <div className="flex items-center gap-1.5 min-w-0">
                    ...
                    <button
                      ...
                      className="w-4.5 h-4.5 rounded-full border border-black/10 hover:border-black/25 text-gray-400 hover:text-gray-600 hover:bg-black/5 flex items-center justify-center text-[10px] font-bold cursor-pointer transition-all shrink-0"
                      title="Open help"
                    >
                      ?
                    </button>
      ...
      {helpTab && helpContent[helpTab] && (
        ...
        >
          <div
            className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-black/5 p-6 w-full max-w-sm animate-in fade-in zoom-in duration-200 text-left font-geist"
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-0.5 rounded-md bg-orange-100 text-[#FF5B04] text-[10px] font-bold font-jetbrains-mono uppercase tracking-wider">
                  {helpContent[helpTab].badge}
                </span>
                <h3 className="text-sm font-bold font-geist text-gray-800">
            ...
            <div className="text-gray-600">
              {helpContent[helpTab].description}
            </div>
            ...
            <div className="mt-5 flex justify-end">
              <button
                type="button"
                onClick={() => setHelpTab(null)}
                className="px-4 py-2 bg-black hover:bg-gray-800 text-white transition-colors text-xs font-semibold rounded-xl cursor-pointer"
              >
                Got it
              </button>
            </div>
