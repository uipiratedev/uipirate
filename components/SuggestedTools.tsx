...
export const ALL_TOOLS_REGISTRY: SuggestedToolItem[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    ctaLabel: "Try Interactive Preview",
    description:
      "Score headline clarity, CTA prominence, trust signals, and conversion probability in 1 scan.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <line x1="16" x2="16.01" y1="4" y2="4" />
        <line x1="20" x2="20.01" y1="4" y2="4" />
        <line x1="20" x2="20.01" y1="8" y2="8" />
        <line x1="20" x2="20.01" y1="12" y2="12" />
        <line x1="4" x2="4.01" y1="16" y2="16" />
        <line x1="4" x2="4.01" y1="20" y2="20" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <line x1="5" x2="5" y1="7" y2="17" />
        <line x1="19" x2="19" y1="7" y2="17" />
        <line x1="7" x2="17" y1="5" y2="5" />
  ...
  },
  {
    ...
    description:
      "Configure robots.txt to permit AI search citation bots while blocking aggressive data training scrapers.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Test robots.txt syntax against RFC 9309 standards and prevent accidental search crawler lockouts.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Build validated JSON-LD structured data for Organization, FAQPage, SaaS WebApps, and Products.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Audit up to 10 competitor or client domains simultaneously to benchmark AI bot permissions.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Comprehensive database of 26+ AI crawlers, User-Agents, reverse DNS hosts, and blocking tradeoffs.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Explore related utilities in this workflow or discover
