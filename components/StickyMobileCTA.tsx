...
/**
 * Sticky Mobile CTA - Always visible WhatsApp button on mobile
...
const StickyMobileCTA = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-0 left-0 right-0 z-50 p-4 pb-6 bg-gradient-to-t from-white via-white to-transparent pointer-events-none"
    >
      <a
