      ...
      <div className="container mx-auto px-32 lg:px-20 max-md:px-4 pt-32 pb-20 relative z-10">
        ...
        >
          ...
          <h1 className="hero-header">
            AI Crawler &amp; Bot{" "}
            <span className="text-[#FF5B04]">Directory</span>
          </h1>
          <p className="text-base sm:text-lg text-gray-500 max-w-3xl mx-auto text-center font-normal leading-relaxed">
            Searchable encyclopedia of AI crawlers, LLM training bots, search
            engines, and scrapers. Look up exact User-Agents, operators, and
            behaviors.
          </p>
        </motion.div>
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-none">
            {[
              { id: "all", label: "All Crawlers", count: AI_BOTS.length },
              {
                id: "ai-training",
                label: "AI Training",
                count: AI_BOTS.filter((b) => b.category === "ai-training")
                  .length,
              },
              {
                id: "ai-search",
                label: "AI Search & Retrieval",
                count: AI_BOTS.filter((b) => b.category === "ai-search").length,
              },
              {
                id: "search-engine",
                label: "Search Engines",
                count: AI_BOTS.filter((b) => b.category === "search-engine")
                  .length,
              },
              {
                id: "seo-tool",
                label: "SEO Tools",
                count: AI_BOTS.filter((b) => b.category === "seo-tool").length,
              },
              {
                id: "social",
                label: "Social Previews",
                count: AI_BOTS.filter((b) => b.category === "social").length,
              },
            ].map((tab) => {
        ...
        <section className="mt-24 pt-14 border-t border-gray-200 max-w-5xl mx-auto space-y-16">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xs text-gray-500 mt-2 leading-relaxed">
              Not all crawlers are the same. A modern search strategy treats
              foundation model training bots, conversational citation agents,
              and traditional search engines differently.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                <code className="font-mono text-gray-800">ClaudeBot</code>, and{" "}
                <code className="font-mono text-gray-800">CCBot</code> scrape
                massive datasets to train next-gen weights. Blocking them
                preserves IP without hurting search ranking.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                and{" "}
                <code className="font-mono text-gray-800">PerplexityBot</code>{" "}
                fetch real-time web pages to answer live user queries with
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                , <code className="font-mono text-gray-800">Twitterbot</code>,
                and <code className="font-mono text-gray-800">AhrefsBot</code>{" "}
                power rich share cards and technical backlink monitoring.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  Perform a reverse DNS lookup on the visiting IP address. For
                  instance, authentic Googlebot visits resolve to{" "}
                  <code className="font-mono text-gray-800">
                    *.googlebot.com
                  </code>{" "}
                  and OpenAI visits resolve to{" "}
                  <code className="font-mono text-gray-800">*.openai.com</code>.
                </p>
              </div>
              <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100">
                <h4 className="text-xs font-bold text-gray-900 mb-1">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  No. Blocking training crawlers like GPTBot or
                  Applebot-Extended has zero impact on traditional Google or
                  Bing organic search visibility.
                </p>
              </div>
            </div>
          </div>
